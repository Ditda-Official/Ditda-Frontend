...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  choose:
    "rounded-8 px-3 py-1 bg-gray-20 text-gray-60 text-body1-sb hover:bg-gray-40 active:bg-purple-20 active:border-purple-30 active:text-main-main border border-transparent",
};
